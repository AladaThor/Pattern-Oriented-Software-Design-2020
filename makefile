...
TEST = test/ut_app.h test/ut_folder.h test/ut_iterator.h test/ut_utility.h test/ut_visitor.h test/ut_node_builder.h test/ut_node_scanner.h test/ut_node_parser.h
OBJ = obj/node.o
